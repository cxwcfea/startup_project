                    ...
                    mockTrader.Portfolio.find({userId: user.id}, function(err, portfolio) {
                        ...
                        for (var p in portfolio) {
                            ...
                            mockTrader.Contract.findOne({_id: portf.contractId}, function(err, contract) {
                                ...
                                if(portf.quantity > 0){
                                    var trigger_in_price = buy_price + parseFloat(user.winPoint)/(contract.point_value/100) + 1;
                                    var trigger_out_price = buy_price - parseFloat(user.lossPoint)/(contract.point_value/100) + 1;
