...
function collectOperationData(cb) {
    ...
    async.waterfall([
        ...
        function (callback) {
            Apply.find({$and:[{status:2}, {status:5}]}, function(err, applies) {
        ...
        function (callback) {
            ...
            Order.find({$and:[{status:1}, {createdAt:{$gte:startTime.toDate()}}, {createdAt:{$lt:endTime.toDate()}}]}, function(err, orders) {
                callback(err, orders);
            });
        },
