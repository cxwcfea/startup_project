...
function getManagerMenu() {
    var StockButton = new ComplexButton('stock');
    var AppDownLoadButton = new ComplexButton('download');
    var MyAccountButton = new ComplexButton('my accout');

    var ButtonFreeTry = new ButtonUrl('free','http://m.niujinwang.com/free_apply');
    var ButtonDaysNiu = new ButtonUrl('ttn','http://m.niujinwang.com/mobile/#/ttn');

    StockButton.sub_button[0] = ButtonFreeTry;
    StockButton.sub_button[1] = ButtonDaysNiu;

    var ButtonIPhoneApp = new ButtonUrl('iPhone','http://www.baidu.com');
    var ButtonAndroidApp = new ButtonUrl('Android','http://www.ihoms.com/file/xunlei/downloadxunlei/HOMS_YONGJINBAN_android.apk?fileCode=38&sourceType=4');

    AppDownLoadButton.sub_button[0] = ButtonIPhoneApp;
    AppDownLoadButton.sub_button[1] = ButtonAndroidApp;

    var ButtonRegister= new ButtonUrl('signup','http://test2.niujinwang.com/mobile/#/signup');
    var ButtonLogin = new ButtonUrl('login','http://test2.niujinwang.com/mobile/#/login');
    var ButtonUser = new ButtonUrl('userCenter','http://test2.niujinwang.com/mobile/#/user');
