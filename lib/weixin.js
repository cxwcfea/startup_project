...
function sendRechargeSuccessMsg(req, res) {
    ...
    postToWeixin('https://api.weixin.qq.com/cgi-bin/message/template/send?access_token=', sendData);
    res.send({});
}
...
function postToWeixin(url, content) {
    getToken(function(err, token) {
        ...
        needle.post(url + token, content, {}, function(err, resp, body) {
            if (err) {
                console.log(err);
            }
            console.log(body);
