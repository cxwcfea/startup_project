...
function getManagerMenu() {
    ...
    var ButtonFreeTry = new ButtonUrl('免费体验','http://server2.niujinwang.com/mobile/#/exp');
    var ButtonDaysNiu = new ButtonUrl('天天牛','http://server2.niujinwang.com/mobile/#/ttn');
    var ButtonIPhoneApp = new ButtonUrl('iPhone版下载','https://itunes.apple.com/cn/app/homs-yong-jin-ban/id950510961?mt=8');
    var ButtonAndroidApp = new ButtonUrl('Android版下载','http://www.ihoms.com/file/xunlei/downloadxunlei/HOMS_YONGJINBAN_android.apk?fileCode=38&sourceType=4');
    StockButton.sub_button[0] = ButtonFreeTry;
    StockButton.sub_button[1] = ButtonDaysNiu;
    StockButton.sub_button[2] = ButtonIPhoneApp;
    StockButton.sub_button[3] = ButtonAndroidApp;

    var InvestmentButton = new ComplexButton('投资赚钱');
    var ButtonInvestment = new ButtonUrl('天天投', 'http://server2.niujinwang.com/mobile/#/invest');
    InvestmentButton.sub_button[0] = ButtonInvestment;

    var MyAccountButton = new ComplexButton('我的账户');
    var ButtonUser = new ButtonUrl('个人中心','http://server2.niujinwang.com/mobile/#/user');
    var ButtonWeixin = new ButtonClick('绑定微信','binding');
    var ButtonLoginLongterm = new ButtonUrl('免登录','http://server2.niujinwang.com/mobile/#/login_longterm');
