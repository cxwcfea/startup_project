...
function ButtonClick(btnName, btnUrl) {
    this.type = 'click';
    this.name = btnName;
    this.url = btnUrl;
}
...
module.exports.handlePostMessage = function(req, res) {
    console.log('handlePostMessage ' + req.body.toString());
    res.send({});
};
...
function getManagerMenu() {
    ...
    var ButtonUser = new ButtonClick('个人中心','http://www.niujinwang.com/mobile/#/user');
