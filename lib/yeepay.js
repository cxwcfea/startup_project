...
var client_private = '-----BEGIN RSA PRIVATE KEY-----\n'+
    ...
    '-----END RSA PRIVATE KEY-----';
var client_public  = '-----BEGIN PUBLIC KEY-----\n'+
    'MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDJVxZne5HqiN1Hxiew/Ply2J8D5\n'+
    '3mxiXMG7q1+Z3XxvgDFlY3yooUSDXWRHEadbyrctREuiDeK7nDpfJe4vJHL1XhSTc\n'+
    'DQ2q2NqApkkd3uw3T/gH5hzWjFEttwlAD75TxBL/o5tooWyMybdvKpxAA9y7+9Y+m\n'+
    '+pCkeSjWD0monawIDAQAB\n'+
    '-----END PUBLIC KEY-----';
    ...
    */
    ...
    async.waterfall([
        function (callback) {
            ...
            result = JSON.parse(result);
            logger.debug(result);
            if (result.error_code || result.status === 0) {
