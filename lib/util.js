...
var sms_macro = [
    ...
    },
    {
        ...
        value: 13,
        content: 'AMOUNT元配资(ACCOUNT)将于明天到期，请在明天13:00前选择延期或在14:50前清仓。祝您操盘愉快！'
    }
];
...
module.exports.getTodayAddedDeposit = function(cb) {
    ...
    Apply.find({$and:[{startTime:{$lte:endTime}}, {startTime:{$gte:startTime}}, {status:{$ne:1}}, {status:{$ne:9}}]}, function(err, applies) {
        if (err) {
