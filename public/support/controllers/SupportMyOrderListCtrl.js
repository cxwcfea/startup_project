'use strict';
angular.module('supportApp').controller('SupportMyOrderListCtrl', ['$scope', '$location', '$routeParams', '$modal', '$http', 'gbNotifier', 'supportApply', '$filter', '$window', function($scope, $location, $routeParams, $modal, $http, gbNotifier, supportApply, $filter, $window) {
    var vm = this;
    var order_list = {};
    var currentOrders;
    vm.itemsPerPage = 15;
