'use strict';
angular.module('supportApp').controller('SupportOrderListCtrl', ['$scope', '$location', '$routeParams', '$modal', '$http', 'supportOrder', 'gbNotifier', 'gbUser', function($scope, $location, $routeParams, $modal, $http, supportOrder, gbNotifier, gbUser) {
    var vm = this;
    var order_list = {};
    var currentOrders;
    vm.itemsPerPage = 15;
