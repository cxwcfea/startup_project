'use strict';
angular.module('mobileApp').controller('MobileTtnConfirmCtrl', ['$scope', '$window', '$location', '$http', 'days', 'service_charge', function($scope, $window, $location, $http, days, service_charge) {
    var vm = this;
    vm.apply = {};
