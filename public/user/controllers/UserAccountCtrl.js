'use strict';
angular.module('userApp').controller('UserAccountCtrl', ['$scope', '$filter', '$window', '$http', '$interval', '$location', '$timeout', 'BankNameList', 'njCard', function($scope, $filter, $window, $http, $interval, $location, $timeout, BankNameList, njCard) {
    var vm = this;
