'use strict';
angular.module('userApp2').controller('UserApplyCtrl2', ['$scope', '$window', '$location', '$routeParams', '$modal', '$http', 'njApply', 'warn_factor', 'sell_factor', 'days', function($scope, $window, $location, $routeParams, $modal, $http, njApply, warn_factor, sell_factor, days) {
    var vm = this;
